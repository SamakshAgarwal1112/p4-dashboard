  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <main className="container mx-auto px-4 py-6">
        {/* Metrics Cards */}
        <MetricsCards packets={packets.slice(0, 24)} />

        {/* Packet Flow Chart */}
        <div className="mb-6">
          <PacketFlowChart packets={packets.slice(0, 24)} />
        </div>

        {/* Protocol and Size Charts */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          <ProtocolChart packets={packets.slice(0, 24)} />
          <PacketSizeChart packets={packets.slice(0, 24)} />
        </div>

        {/* Live Packet Table */}
        <PacketTable packets={packets.slice(0, 24)} />
      </main>
